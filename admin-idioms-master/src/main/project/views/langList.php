        ...
        <div class="flex-1 w-auto">
            <div class="flex mt-10 ml-12 items-center">
                <div class="flex-1 flex justify-center">
                    ...
                    <a class="m-4 text-sm bg-transparent border-solid border-2 border-teal-800 hover:bg-teal-800 hover:text-white text-teal-800 font-bold py-2 px-4 rounded w-40 text-center" href="/?Controller=AdminText&method=createLang">Añadir Idioma</a>
                </div>
            ...
            <div class="p-9 flex justify-center">
                <ul>
                    ...
                    ?>
                        <a class="" href="/?Controller=AdminText&method=editLang&tag=<?= $langs->getTag() ?>">
                            <li class="bg-sky-300 my-3 rounded-2xl w-full mb-8 hover:bg-sky-500 ease-in-out duration-300 animation-expanded">
                                <div class="">
                                    <table class="table-auto mx-18 text-left">
                                        ...
                                        <tr>
                                            <td class="p-2 px-12 flex justify-start w-64">
                                            ...
                                            <td class="p-2 px-12 flex justify-end w-16">
                                                <a class="delete" href="/?Controller=AdminText&method=destroyLang&tag=<?= $langs->getTag() ?>">
